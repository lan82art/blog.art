        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        <td><?= $value['idinfo']; ?></td><td><input type="checkbox" name="group_del[]" value="<?= $value['idinfo']; ?>"/><br></td><td><?= $value['info_name'] ?></td><td><?= mb_substr($value['info_description'],0,50,'UTF-8')."..." ?></td><td>
