...
<div class="container" style="padding: 70px 15px;">
    <div class="row">
        <div class="col-xs-12">
            <h2><?= $GLOBALS['title']?></h2>
            <form action="/admin/index.php?route=apply_edit" method="post">
                ...
                <button type="submit" class="btn btn-success" name="apply_insert">Создать</button>
                <?php } elseif ($_GET['action'] == 'edit') { ?>
                <button type="submit" class="btn btn-warning" name="apply_update">Обновить</button>
                <?php } ?>
            </form>
        </div>
    </div>
