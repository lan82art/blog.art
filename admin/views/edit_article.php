<?php getHeader(); ?>
    ...
    <div class="container" style="padding: 70px 15px;">
        <div class="row">
            <div class="col-xs-12">
                <h2><?= $GLOBALS['title']?></h2>
                <form action="/admin/index.php?route=art_apply_edit" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="idcategory" placeholder="Категория" name="idcategory" value="<?php if(!empty($GLOBALS['article'][0]['idcategory'])) echo $GLOBALS['article'][0]['idcategory'] ?>">
                    </div>
                    <div class="form-group">
